      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            For emergencies, call our 24/7 hotline immediately. For non-emergency inquiries, 
            use the contact form below or reach us through other channels.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          {/* Contact Information */}
          <div>
            <div className="bg-red-600 text-white p-8 rounded-xl mb-8">
              <h3 className="text-2xl font-bold mb-4">Emergency Hotline</h3>
              <div className="flex items-center text-xl">
                <Phone className="w-6 h-6 mr-3" />
                <a href="tel:+919876543210" className="hover:text-red-200">
                  +91-98765-43210
                </a>
              </div>
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@jyotiambulance.com</p>
                    <p className="text-gray-600">emergency@jyotiambulance.com</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Service Hours</h4>
                    <p className="text-gray-600">
                      Emergency Services: 24/7<br />
                      Office Hours: 9:00 AM - 6:00 PM<br />
